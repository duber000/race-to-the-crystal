// ==========================================================================
// Input Controller - Extracted from InputHandler to reduce complexity
// ==========================================================================

import { CELL_SIZE, INPUT_CONFIG } from './game_client.constants.js';

/**
 * Input Controller - Handles input interpretation and game action mapping
 * Extracted from InputHandler to reduce complexity
 */
class InputController {
     ...
     */
    constructor(canvas, cameraController, getGameState, getConnectionState, engine, deviceCapabilities) {
        this.canvas = canvas;

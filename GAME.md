...
* each generator "taken out" reduces the players needing to hold the crystal by 2
* tokens have these numbers on their dice representing their health, 10, 8, 6, 4
* 6 and 4 tokens can move two spaces, everyone else moves 1
* each token attacks for 1/2 of their value
(10 for 5, 8 for 4 etc) - attacker takes no damange
* in random spots there are mystery squares (equal in each quadrant) that make you flip a coin - heads you heal to full, tails you head back to start 
